...
public class MyException {
    ...
    static {
        ...
        DEFAULT_ERROR_LIST.add(com.zyc.exception.MyLoginException.class);
    }
     ...
     */
    public String handle(final org.jasig.cas.authentication.AuthenticationException e, final MessageContext messageContext) {
        if (e != null) {
